...
class HeatmiserThermostat(object):
    ...
    def __init__(self, address: int, model: str, uh1, name: str = ""):
        """
...
#     def thermostat_models(self):
#         """
#         Returns a dict which translates model codes to readable strings
#         """
#         return {0: "DT", 1: "DT/E", 2: "PRT", 3: "PRT-E", 4: "PRTHW", 5: "TM1"}
